  ...
  return (
    <div className="navbar-container">
        ...
        <div className="navBar-links">
            ...
            <Link className="nav-link-item" to="/top-headlines" ><p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
